...
urlpatterns = [
    ...
    path("lista-tareas/", nueva_lista, name="nueva_lista"),                    # http://127.0.0.1:8000/lista-tareas aquí se crea una lista de tareas
    path("lista-tareas/<int:lista_pk>", vista_lista, name="lista"),            # http://127.0.0.1:8000/lista-tareas/70 mostrar la lista de tareas con ID = 70
