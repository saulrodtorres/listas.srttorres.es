...
urlpatterns = [
    ...
    path("lista-tareas/nueva", views.nueva_lista, name="nueva_lista"),                    # http://127.0.0.1:8000/lista-tareas aquí se crea una lista de tareas
    ...
    path("tarea/nueva/<int:lista_pk>", views.nueva_tarea, name="nueva_tarea"),               
    path("tarea/<int:tarea_pk>/", views.vista_tarea, name="tarea"),
    path("tarea/<int:tarea_pk>/borrar", views.borrar_tarea, name="borrar_tarea"),               
